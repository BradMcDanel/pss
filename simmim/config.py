...
# Patch Scheduler
_C.TRAIN.PATCH_SCHEDULER = CN()
_C.TRAIN.PATCH_SCHEDULER.NAME = 'linear'
_C.TRAIN.PATCH_SCHEDULER.START_PATCH_DROP_RATIO = 0.0
_C.TRAIN.PATCH_SCHEDULER.END_PATCH_DROP_RATIO = 0.0
_C.TRAIN.PATCH_SCHEDULER.COOLDOWN_EPOCHS = 0

_C.TRAIN.PATCH_DROP_FUNC = 'magnitude'
